    ...
    concat: {
      all: {
        src: [
          ...
          , '<%= paths.game.js %>prefabs/Engine.js'
          , '<%= paths.game.js %>prefabs/RPM.js'
          , '<%= paths.game.js %>prefabs/Speedometer.js'
          , '<%= paths.game.js %>prefabs/GearBox.js'
          , '<%= paths.game.js %>prefabs/Gears.js'
          , '<%= paths.game.js %>prefabs/Pedals.js'
